...
c3 = np.loadtxt("cent-remGrad-all-6.txt")[:,:30][:,1::3]#[:,1::20]#np.loadtxt("cent-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
c2 = np.loadtxt("decent-remGrad-all-s3-6.txt")[:,:30][:,1::3]#[:,1::20]#np.loadtxt("eights-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
c1 = np.loadtxt("decent-remGrad-all-s2-6.txt")[:,:30][:,1::3]#[:,1::20]#np.loadtxt("sevens-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
dif = np.loadtxt("decent-remGrad-all-s1-6.txt")[:,:30][:,1::3]#[:,1::20]#np.loadtxt("decent-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
cSite1 = np.loadtxt("eights-remGrad-all-6.txt")[:,:30][:,1::3]#[:,1::20]
cSite2 = np.loadtxt("sevens-remGrad-all-6.txt")[:,:30][:,1::3]#[:,1::20]
cSite3 = np.loadtxt("zeros-remGrad-all-6.txt")[:,:30][:,1::3]#[:,1::20]
...
seaborn.plt.savefig("mixed_gradients_not_zeros.svg",bbox_inches="tight",pad_inches=0)
seaborn.plt.show(g)
