...
c4 = np.loadtxt("up-new-3-site-cent-horn1-x.txt")
c3 = np.loadtxt("up-new-3-site-cent-horn2-x.txt")
c2 = np.loadtxt("up-new-3-site-cent-middle-x.txt")
c1 = np.loadtxt("up-new-3-site-cent-x.txt")
dif = np.loadtxt("up-new-3-site-decent-s1-x.txt")
dif2 = np.loadtxt("up-new-3-site-decent-s2-x.txt")
dif3 = np.loadtxt("up-new-3-site-decent-s3-x.txt")
...
#c3w = np.c_[c4,axe]
fw = np.concatenate((dif,dif2), axis = 0)
...
decent_keys = ["Decentralized site1"]*10
decent_keys_2 = ["Decentralized site2"]*10
decent_keys_3 = ["Decentralized site3"]*10
horn1_keys = ["Horn1"]*10
horn2_keys = ["Horn2"]*10
mid_keys = ["Middle"]*10
cent_keys = ["Centralized"]*10
s["class"] = pd.Series(decent_keys + decent_keys_2 + decent_keys_2 + horn1_keys + cent_keys + horn2_keys + mid_keys, index = s.index,dtype="category")
