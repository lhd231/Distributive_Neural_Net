...
c3 = np.loadtxt("cent-sameBatch-all-test-3.txt")[:,::5]#np.loadtxt("cent-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
dif = np.loadtxt("decent-sameBatch-all-test-3.txt")[:,::5]#np.loadtxt("decent-sameBatch-all-test-2.txt")[:,:20]#[:,:10]
cSite1 = np.loadtxt("eights-sameBatch-all-test-3.txt")[:,::5]
cSite2 = np.loadtxt("sevens-sameBatch-all-test-3.txt")[:,::5]
cSite3 = np.loadtxt("zeros-sameBatch-all-test-3.txt")[:,::5]
...
seaborn.plt.savefig("mnist_all_classes.svg",bbox_inches="tight",pad_inches=0)
