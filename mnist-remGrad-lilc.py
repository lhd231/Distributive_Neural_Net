...
nn1Acc = [[[0 for i in range(100)]for x in range(6)] for y in range(3)]
classAcc = [[0 for i in range(100)]for x in range(6)]
eights = [[0 for i in range(100)]for x in range(6)]
sevens = [[0 for i in range(100)]for x in range(6)]
zeros = [[0 for i in range(100)]for x in range(6)]
number_of_sites = 3
sample_size = 10
def sing_run(te):
    print te
...
np.savetxt("decent-remGrad-s1.txt",nn1Acc[0])
np.savetxt("decent-remGrad-s2.txt",nn1Acc[1])
np.savetxt("decent-remGrad-s3.txt",nn1Acc[2])
np.savetxt("cent-remGrad.txt",classAcc)
np.savetxt("eights-remGrad.txt",eights)  
np.savetxt("sevens-remGrad.txt",sevens)
np.savetxt("zeros-remGrad.txt",zeros)
